...
jQuery.fn.showLoading = function (options) {
    ...
    if (settings.overlayWidth !== null) {
        ...
        //overlay_width = parseInt(jQuery(window).width()) + parseInt(jQuery(this).css('padding-right')) + parseInt(jQuery(this).css('padding-left'));
    }
    ...
    if (settings.overlayHeight !== null) {
        ...
        //overlay_height = parseInt(jQuery(window).height()) + parseInt(jQuery(this).css('padding-top')) + parseInt(jQuery(this).css('padding-bottom'));
    }
...
//    jQuery(overlayDiv).css('position', 'absolute');
    ...
    jQuery(overlayDiv).css('opacity', '0.6');
    ...
    jQuery(loadingDiv).css('margin-top', '-'+parseInt(jQuery(this).height()/3)+'px');
    jQuery(loadingDiv).append('<i>Menunggu</i>');
    jQuery(loadingDiv).css('position', 'fixed');
